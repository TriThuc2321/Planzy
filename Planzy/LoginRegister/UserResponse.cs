...
namespace Planzy.LoginRegister
{
    public class UserResponse
    {
        ...
        public static UserResponse get(string response)
        {
            UserResponse result = JsonConvert.DeserializeObject<UserResponse>(response);
        ...
        public void refresh()
        {
            ...
            var refreshResponse = UserResponse.get(responseString);
            this.access_token = refreshResponse.access_token;
            this.created = DateTime.Now;
        }


        public static UserResponse Exchange(string authCode, string clientid, string secret, string redirectURI)
        {
            ...
            var x = UserResponse.get(responseString);
